...
public class Buffer {
    ...
    public Buffer() {
        // Initialize stack for the left and the right
    ...
    public void left(int k) {
        for (int i = 0; i < k; i++) {
            char c = left.pop(); // delete item in the left stack
            right.push(c); // insert this item to the right (next right)
        }
    }
    ...
    public void right(int k) {
        for (int i = 0; i < k; i++) {
            char c = right.pop(); // delete item in the right stack
            left.push(c); // insert this item to the left
        }
    }
